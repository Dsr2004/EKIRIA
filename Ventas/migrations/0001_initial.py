# Generated by Django 3.2.9 on 2022-04-21 13:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_pagar', models.IntegerField(blank=True, null=True, verbose_name='Total a pagar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente_id', models.ForeignKey(db_column='cliente_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cliente_id', to=settings.AUTH_USER_MODEL)),
                ('empleado_id', models.ForeignKey(db_column='empleado_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='empleado_id', to=settings.AUTH_USER_MODEL)),
                ('pedido_id', models.ForeignKey(db_column='pedido_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Ventas.pedido', verbose_name='Id del Pedido')),
            ],
            options={
                'verbose_name': 'cita',
