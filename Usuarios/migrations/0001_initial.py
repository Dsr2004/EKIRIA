...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'usuarios',
                'permissions': [('Empleado', 'Es un empleado'), ('Cliente', 'Es un cliente'), ('Administrador', 'Es un administrador')],
            },
        ),
        migrations.CreateModel(
            name='Notificacion',
            fields=[
                ...
                ('usuario_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Usuarios.usuario')),
            ],
            options={
